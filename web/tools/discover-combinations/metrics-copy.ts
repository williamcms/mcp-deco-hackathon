...
export const METRICS = {
  support: {
    ...
    reading:
      "Muitas ocorrências significam alcance — vale para muita gente. Mas sozinho não prova relação: dois produtos campeões de venda se encontram no carrinho sem terem nada a ver um com o outro.",
  },
  confidence: {
    label: "Confidence",
  ...
  incrementalMargin: {
    ...
    short: "Lucro extra que só existe por causa dessa combinação, não o lucro total do pedido.",
    long: "Usa o custo por unidade cadastrado na variante de cada produto na Shopify para achar o lucro (receita - custo) dos pedidos com a combinação. Depois credita só a fatia desse lucro que vem dos pedidos incrementais — os mesmos que o lift mostra que o acaso não explicaria.",
    reading:
      "Não é a margem total da combinação — é só a parte que existe por causa da relação entre os produtos. Lift 1,0x resulta em margem incremental zero, por definição. Aparece como travessão quando nenhum produto da combinação tem custo por unidade cadastrado na Shopify (Produto → Custo por item) — sem custo não dá pra calcular lucro, e mostrar zero seria uma afirmação errada.",
  },
  inventory: {
    label: "Viabilidade",
