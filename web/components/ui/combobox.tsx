...
import { InputGroup, InputGroupAddon, InputGroupButton, InputGroupInput } from "@/web/components/ui/input-group";
...
function ComboboxLabel({ className, ...props }: ComboboxPrimitive.GroupLabel.Props) {
  return (
    <ComboboxPrimitive.GroupLabel
      ...
      className={cn(
        "px-2 pointer-coarse:px-3 py-1.5 pointer-coarse:py-2 text-muted-foreground text-xs pointer-coarse:text-sm",
        className,
      )}
      {...props}
    />
